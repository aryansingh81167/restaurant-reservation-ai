  ...
  return (
    <footer className="bg-surface-container-highest w-full py-section-gap px-margin-desktop grid grid-cols-1 md:grid-cols-3 gap-gutter">
      ...
      <div className="space-y-stack-md">
        ...
        <div className="flex">
          <input className="bg-transparent border-0 border-b border-outline py-2 flex-1 focus:ring-0 focus:border-primary" placeholder="Email Address" type="email" />
          <button className="ml-4 material-symbols-outlined text-primary">arrow_forward</button>
        </div>
