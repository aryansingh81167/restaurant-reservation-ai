      ...
      <main className="pb-section-gap max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <section className="mb-section-gap">
          ...
          <div className="menu-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '48px 24px' }}>
            ...
            <div className="group cursor-pointer">
              <div className="aspect-[4/3] relative overflow-hidden mb-stack-md bg-surface-container">
                <Image alt="Hokkaido Scallops" fill className="object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBIvnd-3wN_fWwUhP-EJXxglW9qmDzM8N0zntQdFM9_FRvTccBWEeaP-cH6ACo9Rk9o62ISwAQi17QhzORTR_lRmhzlVSAIosqHJpDo4kDmldSQi_sHgYiurgit0AfBFuFoBkxbnJd4OPn4_QnXAGfWxWGvDrohyJmrpDILUoQPy0aKHlOGh1GkmZWaAkA3nybAywSeqd2Ozv-cGVwtcB-78fskO8DouuJJV8ebN6AOd-sdG-oRQ8K44HHhIJP5a5ps7lqy4_GHVf4"/>
              </div>
            ...
            <div className="group cursor-pointer">
              <div className="aspect-[4/3] relative overflow-hidden mb-stack-md bg-surface-container">
                <Image alt="Heritage Burrata" fill className="object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCk65Gfaendf1LmpnpSeX0PIllJbSLguhfZrQjxraJGjWn0Wj8DgrZ4VUXWfEwRMg0hGs338cAzUL9gv7ZILXc_jPzU40FFX5pLoh10_EuosDPC8n_xztLLeOSdRSGS7FbtNMZ3XhEgP4FkuYsbJlrKOUQ7qcxQkz4DA77_S1d9-HOtHZTWjsbZEWfjLm1VehkZn8LzBxjO5NMOlBVJak-W_T0ls1EYnOhLajDBKvEPtRulW_pKYI4TxyJMn82Vw5OTKpp1ZERo258"/>
              </div>
              <div className="flex justify-between items-start mb-2">
        ...
        <section className="mb-section-gap">
          ...
          <div className="menu-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '48px 24px' }}>
            ...
            <div className="group cursor-pointer col-span-1 md:col-span-2 flex flex-col md:flex-row gap-8 items-center bg-white p-6 shadow-sm border border-outline-variant/30">
              <div className="w-full md:w-1/2 relative aspect-[16/9] overflow-hidden bg-surface-container">
                <Image alt="A5 Wagyu Reserve" fill className="object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAAFDrROMen32Cy1oKvpfwd-GnGoOorgtjNgYhm_zv-F09fcunaJcf88LsbCQ-Hd1ZqFAjLkb6Ql-BbAJfybk_cZ41fQLkfKBLrTn3IgBgl2P5ytxlSo8FS2D-8PEKOtlBm3e9fHhm98IIuKUgbZVwl5NSN5nIwNdc2Q5HystDubjQmxkjiQmHHBHXvt2b4hkEIuV2mu4xNip43dqrXwTpDoHdg3yK301NMPU4iooVsvRUp1-ZF0rmkanORQDWCjF3vHlHs71hUv4U"/>
              </div>
        ...
        <section className="mb-section-gap">
          ...
          <div className="menu-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '48px 24px' }}>
            <div className="group cursor-pointer">
              <div className="aspect-[4/3] relative overflow-hidden mb-stack-md bg-surface-container">
                <Image alt="Noir Chocolate Fondant" fill className="object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBPLN2NGoEOOZ2ma6ZxWnSWgadScNvWVJ5s54Mbr7iC9smoSuBufK3KRW6148miarrJ2RQWquGiecBxPXfONlAQpGjjIxyetQJOPhakYanvrKh0vRHeb_NvHDlUoL_abvaAJWMGQdSAID7f-USQD0z3ZkpU6dfvJGGXDs_WwytmYaIUrhYvUOO9lqR1w2j8w_fGBUkLMPWtfSizNA2u7jrospXqtG_oLtxUGSWRwZcVcyXGqM7x0WMJ-Gl2SDtm9q1SKWnzNG_UdkM"/>
              </div>
              <div className="flex justify-between items-start mb-2">
            ...
            <div className="group cursor-pointer">
              <div className="aspect-[4/3] relative overflow-hidden mb-stack-md bg-surface-container">
                <Image alt="Lemon Verbena Tart" fill className="object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAc-gwGP2Zyiyi76yqromkNiC-DUSMr9-CymK6TT3zcu1m4r5M_ek1RaM9BQ6fmfy85UTPaTgTXe7C-73dKZyYorsY3VW5AInu0HfRINLHNRge30wY3deMyWTi1SA5nixjiCO0CqdmNvkdKkhroaCdnJvsRGaehXuNwKawOgDDXVHOT-0wqqVB2kbrulWELh9mKrcGaxrE3y_iLmEoriKBd4fuUJGtT6dTc0VZdVL-ZQ0wDXgOuTyBo_Ps1cSMsbG6pIyPk6UJphGo"/>
              </div>
              <div className="flex justify-between items-start mb-2">
